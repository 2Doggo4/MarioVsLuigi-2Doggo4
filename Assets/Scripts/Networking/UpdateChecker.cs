...
public class UpdateChecker {
    ...
    private static readonly string API_URL = "http://api.github.com/repos/2Doggo4/MarioVsLuigi-2Doggo4/releases/latest";
    ...
    public async static void IsUpToDate(Action<bool, string> callback) {
        ...
        request.UserAgent = "2Doggo4/MarioVsLuigi-2Doggo4";
